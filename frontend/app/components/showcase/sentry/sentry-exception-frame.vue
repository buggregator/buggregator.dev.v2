...
import IconSvg from '~/shared/ui/icon-svg/icon-svg.vue'
import type { SentryFrame } from '~/shared/types/sentry'

// Stub: no IDE link on landing page
const useIdeLink = () => ({
  buildLink: (_file: string, _line?: number) => null as string | null,
})
